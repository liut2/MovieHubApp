...
class MovieQueryTester(unittest.TestCase):
	...
	# test the main page
	def test_main(self):
		url = "http://thacker.mathcs.carleton.edu:5128/"
	...
	def test_top_rated_typical(self):
		url = "http://thacker.mathcs.carleton.edu:5128/topratedmovies/1"
		data_from_server = requests.get(url).text
		try:
	...
	def test_top_rated_empty(self):
		url = "http://thacker.mathcs.carleton.edu:5128/topratedmovies/0"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_top_rated_null(self):
		url = "http://thacker.mathcs.carleton.edu:5128/topratedmovies/"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server, "Page not found.")

	def test_top_rated_invalid_number_too_high(self):
		url = "http://thacker.mathcs.carleton.edu:5128/topratedmovies/40000"
		data_from_server = requests.get(url).text
	...
	def test_top_rated_invalid_not_a_number(self):
		url = "http://thacker.mathcs.carleton.edu:5128/topratedmovies/meow"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server,"Page not found.")
	...
	def test_favorite_from_year_typical1(self):
		url = "http://thacker.mathcs.carleton.edu:5128/2015/toppicks/2"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_favorite_from_year_typical2(self):
		url = "http://thacker.mathcs.carleton.edu:5128/1995/toppicks/1"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_favorite_from_year_empty(self):
		url = "http://thacker.mathcs.carleton.edu:5128/1995/toppicks/0"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_favorite_from_year_null(self):
		url = "http://thacker.mathcs.carleton.edu:5128/1995/toppicks/"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server,"Page not found.")

	def test_favorite_from_year_invalid1_year_too_low(self):
		url = "http://thacker.mathcs.carleton.edu:5128/1772/toppicks/10"
		data_from_server = requests.get(url).text
	...
	def test_favorite_from_year_invalid3_negative_year(self):
		url = "http://thacker.mathcs.carleton.edu:5128/-5/toppicks/2"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server,"Page not found.")

	def test_favorite_from_year_invalid4_other_ascii_letters(self):
		url = "http://thacker.mathcs.carleton.edu:5128/2014/toppicks/#@!"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server, "Page not found.")

	# test recent_release
	def test_recent_release_typical1(self):
		url = "http://thacker.mathcs.carleton.edu:5128/recentrelease/1"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_recent_release_empty(self):
		url = "http://thacker.mathcs.carleton.edu:5128/recentrelease/0"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_recent_release_null(self):
		url = "http://thacker.mathcs.carleton.edu:5128/recentrelease/"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server, "Page not found.")

	def test_recent_release_invalid1_nagative_number(self):
		url = "http://thacker.mathcs.carleton.edu:5128/recentrelease/-5"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server, "Page not found.")
	...
	def test_toprated_in_genre_typical1(self):
		url = "http://thacker.mathcs.carleton.edu:5128/horror/2"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_toprated_in_genre_upper_case_genre(self):
		url = "http://thacker.mathcs.carleton.edu:5128/Animation/1"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_toprated_in_genre_empty(self):
		url = "http://thacker.mathcs.carleton.edu:5128/drama/0"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_toprated_in_genre_invalid_null_number(self):
		url = "http://thacker.mathcs.carleton.edu:5128/drama/"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server, "Page not found.")

	def test_toprated_in_genre_invalid_null_genre(self):
		url = "http://thacker.mathcs.carleton.edu:5128/132"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server, "Page not found.")

	def test_toprated_in_genre_invalid4(self):
		url = "http://thacker.mathcs.carleton.edu:5128/sfdwere/rwe"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server, "Page not found.")

	def test_toprated_in_genre_invalid5(self):
		url = "http://thacker.mathcs.carleton.edu:5128/drama/12ds"
		data_from_server = requests.get(url).text
		self.assertEqual(data_from_server, "Page not found.")

	# test title contains function
	def test_title_contains_typical1(self):
		url = "http://thacker.mathcs.carleton.edu:5128/titlecontains?query=the+revenant"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_title_contains_typical3(self):
		url = "http://thacker.mathcs.carleton.edu:5128/titlecontains?query=avatar"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_title_contains_not_valid_title(self):
		url = "http://thacker.mathcs.carleton.edu:5128/titlecontains?query=sfdjlkwejrwlerk1213r"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_title_contains_invalid1(self):
		url = "http://thacker.mathcs.carleton.edu:5128/titlecontains?"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
	...
	def test_title_contains_invalid3(self):
		url = "http://thacker.mathcs.carleton.edu:5128/titlecontains?dswe"
		data_from_server = requests.get(url).text
		try:
			received_data = json.loads(data_from_server)
		except ValueError:
